...
import "@/styles/dark-button-styles.css";
...
function DarkModeButton() {
  ...
  function toggleDarkMode() {
    ...
    if (header) {
      header.classList.toggle("bg-[#23272E]");
      header.classList.toggle("shadow-[#1c1f25]");
    ...
    <div>
      <div className="animate__animated animate__backInDown">
        <label id="theme-toggle-button">
          <input onClick={toggleDarkMode} type="checkbox" id="toggle" />
          <svg
